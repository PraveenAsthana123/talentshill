...
// Module 12 on the Operational Portal 10-tab standard. Manual tab wraps
// the pre-existing user/RBAC-role management (unchanged logic), now with
...
export default function AdminUsersPage() {
  return (
    <div className={styles.page}>
      <SectionHeader label="System" title="User Management" subtitle="Admin users and RBAC role assignments, via Manual, Pipeline (deterministic), or Agentic (local LLM) execution modes." />
      <Tabs
        tabs={[
