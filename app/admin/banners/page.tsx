...
// Module 8 on the Operational Portal 10-tab standard. Manual tab wraps
// the pre-existing banner CRUD (unchanged logic), now with real
// operation_run transactional history added. This module's admin API was
// already correctly RBAC-gated -- no security remediation needed here.
export default function AdminBannersPage() {
  return (
    <div className={styles.page}>
      <SectionHeader label="Operations" title="Banners" subtitle="Site-wide banners with scheduling, via Manual, Pipeline (deterministic), or Agentic (local LLM) execution modes." />
      <Tabs
        tabs={[
