...
// Module 4 on the Operational Portal 10-tab standard. Manual tab wraps
// the pre-existing, already-working contacts list/import/export (unchanged
// logic), now with real operation_run transactional history added.
export default function AdminContactsPage() {
  return (
    <div className={styles.page}>
      <SectionHeader label="CRM" title="Contacts" subtitle="Contact database, scored via Manual, Pipeline (deterministic), or Agentic (local LLM) execution modes." />
      <Tabs
        tabs={[
