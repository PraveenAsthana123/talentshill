...
export default function AgenticTab() {
  ...
  const run = async () => {
    ...
    try {
      const res = await fetch('/api/admin/content/agentic/', {
  ...
  return (
    <div>
      <div className={styles.subSection}>
        ...
        <p>Reuses the real readiness pipeline as its &quot;search&quot; step, then drafts a real LLM-written pre-publish recommendation — local Ollama (phi4-mini), 1 agent (&quot;content_readiness_advisor&quot;). Advisory only — never publishes or edits the content.</p>
      </div>
      <div className={styles.subSection}>
        <h4>Input</h4>
