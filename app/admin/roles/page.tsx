...
// Module 13 on the Operational Portal 10-tab standard. Manual tab wraps
// the pre-existing role/permission management, now with real
// operation_run transactional history AND a real bug fix: the permission
// grid previously only covered 20 of 38 real RBAC resources (hardcoded
// list), now derived from the real permissions the API returns.
export default function AdminRolesPage() {
  return (
    <div className={styles.page}>
      <SectionHeader label="System" title="Roles & Permissions" subtitle="RBAC roles and permission sets, via Manual, Pipeline (deterministic), or Agentic (local LLM) execution modes." />
      <Tabs
        tabs={[
