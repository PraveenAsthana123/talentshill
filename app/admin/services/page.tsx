...
// Module 10 on the Operational Portal 10-tab standard. Manual tab wraps
// the pre-existing services CRUD (unchanged logic), now with real
  ...
  return (
    <div className={styles.page}>
      <div className="container section">
        <h1 className={styles.pageTitle} style={{ marginBottom: 'var(--space-6)' }}>Services</h1>
        <Tabs
          tabs={[
