...
// Module 6 on the Operational Portal 10-tab standard. Manual tab wraps
// the pre-existing blog dashboard (unchanged logic), now with real
// operation_run transactional history added. Built alongside a real
// security fix: see Governance tab (GovAI/Risk AI) for the 2026-09-09
// unauthenticated-access finding and remediation -- the most severe
// finding across the modules audited so far (PII + content-integrity +
// draft-disclosure combined).
export default function AdminBlogPage() {
  return (
    <div className={styles.page}>
      <div className="container section">
        <SectionHeader label="Admin" title="Blog Dashboard" subtitle="Manage posts, track analytics, and publish content via Manual, Pipeline (deterministic), or Agentic (local LLM) execution modes." />
        <Tabs
          tabs={[
