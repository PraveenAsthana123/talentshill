...
// Module 7 on the Operational Portal 10-tab standard. Manual tab wraps
// the pre-existing survey analytics dashboard (unchanged logic), now
// with real operation_run transactional history added. Unlike
// appointments/blog, this module's admin API was already correctly
// RBAC-gated -- no security remediation needed here.
export default function AdminSurveyPage() {
  return (
    <div className={styles.page}>
      <div className="container section">
        <h1 className={styles.pageTitle}>Survey Analytics</h1>
        <p className={styles.pageSubtitle}>AI Readiness Assessment insights, via Manual, Pipeline (deterministic), or Agentic (local LLM) execution modes.</p>
        <Tabs
          tabs={[
