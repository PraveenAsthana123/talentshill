...
export default function LogTrackingTab() {
  ...
  useEffect(() => {
    fetch('/api/admin/operation-runs/?moduleKey=competitor_analysis&limit=200')
  ...
  return (
    <div className={styles.subSection}>
      ...
      <p className={styles.empty}>
        Historical record of every operation on this module (distinct from the Monitoring tab, which
        is real-time telemetry) — what ran, when, by whom, with what outcome. Every row is a real
        operation_run entry, append-only.
      </p>
