...
// Module 17 on the Operational Portal 10-tab standard. Manual tab wraps
// the pre-existing broadcast create/launch/delete flow (unchanged
...
export default function AdminBroadcastsPage() {
  return (
    <div className={styles.page}>
      <SectionHeader label="Operations" title="Broadcasts" subtitle="Send bulk email broadcasts to your audiences, via Manual, Pipeline (deterministic readiness scoring), or Agentic (local LLM) execution modes." />
      <Tabs
        tabs={[
