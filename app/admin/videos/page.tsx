...
// Module 11 on the Operational Portal 10-tab standard. Manual tab wraps
// the pre-existing videos CRUD (unchanged logic), now with real
  ...
  return (
    <div className={styles.page}>
      <div className="container section">
        <h1 className={styles.pageTitle} style={{ marginBottom: 'var(--space-6)' }}>Videos</h1>
        <Tabs
          tabs={[
