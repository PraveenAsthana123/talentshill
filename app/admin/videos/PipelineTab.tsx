...
export default function PipelineTab() {
  ...
  const loadRuns = () => {
    fetch('/api/admin/operation-runs/?moduleKey=videos&executionMode=pipeline&limit=20')
  ...
  const run = async () => {
    ...
    try {
      const res = await fetch('/api/admin/videos/pipeline/', {
  ...
  return (
    <div>
      <div className={styles.subSection}>
        ...
        <p>Score a video record&apos;s real public-page readiness — thumbnail, summary substance, tags, category, duration, active status — writes to the real, previously-unused <code>videos.content_score</code> field.</p>
      </div>
      <div className={styles.subSection}>
        <h4>Input</h4>
