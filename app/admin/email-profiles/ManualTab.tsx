...
import sharedStyles from './ProfilesShared.module.css';
...
export default function ManualTab() {
  ...
  useEffect(() => {
    fetch('/api/admin/operation-runs/?moduleKey=email_profiles&executionMode=manual&limit=20')
  ...
  return (
    <div>
      <div className={sharedStyles.subSection}>
        ...
        <p>Manage email sending profiles, SMTP configs, and event routing — real create/assign/delete control.</p>
      </div>
      <div className={sharedStyles.subSection}>
        <h4>Checklist</h4>
        <ul><li>Link a real SMTP config to every profile — an unlinked profile silently falls back to process.env vars at send time</li><li>Run Pipeline or Agentic readiness scoring after creating or editing a profile</li></ul>
      </div>
